...
class ReplyText_MediaTextCell: UITableViewCell {
    ...
    func configure(with message: Messages, currentUser: String) {
        ...
        readIndicatorImageView.image = UIImage(named: "read_indicator", in: Bundle(for: ReplyText_MediaTextCell.self), compatibleWith: nil)
        
        messageMediaImage.image = UIImage(named: "userPlaceholder", in: Bundle(for: ReplyText_MediaTextCell.self), compatibleWith: nil)
