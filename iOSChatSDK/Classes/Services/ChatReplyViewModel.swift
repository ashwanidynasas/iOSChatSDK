...
//        }
    ...
    func uploadFileChatReplyImageWithText(accessToken: String, roomID: String, eventID: String, body: String, msgType: String, mimetype: String? = nil , fileName: String? = nil, imageFilePath: UIImage? = nil, completion: @escaping (Result<UploadResponse, Error>) -> Void) {
