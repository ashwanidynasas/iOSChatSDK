...
class BottomViewHandler {
    ...
    init(replyBottomView: UIView, backTFView: UIView, morebottomView: UIView,
         replyBottomViewHeight: NSLayoutConstraint, textFieldViewHeight: NSLayoutConstraint,
         moreViewHeight: NSLayoutConstraint, backBottomViewHeight: NSLayoutConstraint) {
